...
<form action="{{ url('projects') }}" method="post">
	...
	<div class="form-group">
		...
		<input id="git_main_branch_name" type="text" class="form-control @if ($errors->has('git_main_branch_name')) is-invalid @endif" name="git_main_branch_name"  value="{{ old('git_main_branch_name') }}">
